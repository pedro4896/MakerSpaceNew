...
const Post: React.FC<{ post: PostData }> = ({ post }) => {
    // Usar dados reais do post: post.author, post.postImage, post.description
  return (
    <View style={postStyles.postContainer}>
      <View style={postStyles.topLine} />
      <View style={postStyles.postHeader}> <Image source={assets.authorImage1} style={postStyles.authorImage} resizeMode="cover" /> <Text style={postStyles.authorName}>{post.author}</Text> </View>
      ...
      <View style={postStyles.descriptionContainer}>
        <Text style={postStyles.descriptionText}> <Text style={postStyles.authorNameInDescription}>{post.author} - </Text> <Text style={postStyles.descriptionContent}>{post.description}</Text> </Text>
      </View>
